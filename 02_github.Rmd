...
Untracked files:
  (use "git add <file>..." to include in what will be committed)
        .Rproj.user/84604AD9/sources/session-b7b5e526/C5AB7D86
        .Rproj.user/84604AD9/sources/session-b7b5e526/C5AB7D86-contents
        workshop_notes.R
...
Now within our project, we can save and updates files, and as we do, follow the three key steps to keep our local and remote repositories tracking our work and in sync with one another:
