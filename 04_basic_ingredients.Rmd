...
It is worth noting that you can also add some custom styling per page, rather than globally. So while you may want your text to generally be green, you could change the text of one page to be green by putting CSS code in-line in a certain R Markdown page. For example, in your about R Markdown, you could add: 
...
Another useful way of learning CSS is to find sites you like, look at their sites via Developer Tools, and perhaps even go find their CSS styling code, if available like on GitHub. Similarly, there as [CSS templates](https://www.w3schools.com/css/css_templates.asp) out there. Because it is another language, it will inevitebly take some time to get used to, but don't be discouraged!  